...
# Corrected function to retrieve or create a cart ID
...
def add_cart(request, product_id):
    ...
    try:
        ...
        cart_item = CartItem(product=product, quantity=1, cart=cart)
        cart_item.save()
...
# View to remove a product to the cart
...
# View to delete a product to the cart
